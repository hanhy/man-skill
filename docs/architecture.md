...
- also surface `foundation.core.soul.shadowPaths` so the canonical `SOUL.md` source of truth stays explicit when shadow docs like `soul/README.md` exist beside it, plus `foundation.core.voice.shadowPaths` so the canonical `voice/README.md` source of truth stays explicit when shadow docs like `VOICE.md` exist
- do the same for repo-core prose layers by surfacing `foundation.core.memory.shadowPaths` for the canonical `memory/README.md` source of truth when shadow docs like `MEMORY.md` exist, and `foundation.core.skills.shadowPaths` for the canonical `skills/README.md` source of truth when shadow docs like `SKILLS.md` exist
