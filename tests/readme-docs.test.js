...
test('architecture and ingestion docs explain work-loop leader/blocker semantics and sample-manifest entrypoints', () => {
  ...
  assert.match(readme, /explicit `latest material:`, `refresh reasons:`, `missing drafts:`, `evidence:`, `draft sources:`, `draft gaps:`, `fallback:`, `refresh intake:`, `edit:`, `edit paths:`, `manifest inspect:`, `manifest:`, `inspect after editing:`, and `then run:` lines/i);
